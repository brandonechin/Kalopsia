...
export default function Home({ images, handleAnchorClick, currentIndex, carouselImages, goToNext, goToPrevious }) {

  return (
    <div className='flex justify-center'>
      <div className='md:w-3/4 lg:w-1/2'>
        <Carousel handleClick={handleAnchorClick} currentIndex={currentIndex} carouselImages={carouselImages} goToNext={goToNext} goToPrevious={goToPrevious} />
        <h2 className='text-center underline font-medium mt-4 mb-4'> New Arrivals</h2>
        <div className='flex mt-3'>
          <div className='basis-2/4 transform transition scale-100 hover:scale-110 cursor-pointer'>
